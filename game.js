...
let lvl_description = [
    ["Most kezdted a játékot, újonc vagy! Itt az idő elkezdeni dolgozni!", "favagooo.jpg"],
    ["Szépen haladsz a fejlődésben, de van még mit haladni! A fák nem vágják ki magukat!","favagoo.png"],
    ["A favágás a hátad rovására megy. Itt az idő a félretett pénzből saját céget alapítani","favago.jpg"],
    ["Többé nem kell fát vágnod! Megteszik az alkalmazottak!", "asdf.jpg"],
];
...
function refreshProfileStats(){
    ...
    profile_stats.role.innerHTML=lvl_role[lvl];
